    ...
    if ($_FILES['profilePicture']['error'] === UPLOAD_ERR_OK) {
        ...
        if (in_array($fileExtension, $allowedExtensions)) {
            ...
            if (move_uploaded_file($fileTmpPath, $uploadPath)) {
                ...
                $query = "UPDATE itc SET profile_picture = ? WHERE IdNumber = ?";
...
function deleteProfilePicture($conn, $idNumber) {
    ...
    $query = "UPDATE itc SET profile_picture = NULL WHERE IdNumber = ?";
    $stmt = mysqli_prepare($conn, $query);
                    ...
                    <div class="row d-flex justify-content-center text-center pt-4 px-lg-5">
                        <div class="col-lg-8">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <button type="submit" class="btn btn-secondary" name="uploadProfile">Upload New Profile Picture</button>
                            </form>
                        </div>
                    </div>
                </div>
