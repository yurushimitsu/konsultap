...
<head>
    ...
    <title>Cancel Appointment Verification</title>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>Appointment Cancelation</h1>
        </div>
        <div class="greeting">
            <h2>Greetings <span style="font-style: italic; color:#05066d">{{userName}}</span> !</h2>
        </div>
        <p>We are writing to inform you that your appointment scheduled on <b>{{appointmentDate}}</b> from <b>{{formattedTimeInterval}}</b> has been successfully cancelled.</p>
        <div class="verification-code">
            <strong>Reason for cancellation:</strong><br>{{reason}}<br>
        </div>
