...
<body>
    ...
    <div class="container py-5">
        <div class="row justify-content-center text-center px-4">
            <p class="title fs-1 fw-bold" style="color: #000066;">Flu</p>
                ...
                <div class="modal-dialog modal-dialog-scrollable modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">FAQs About Flu</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <img src="../../images/FAQS/flu.png" class="img-fluid">
                        </div>
                        <div class="modal-footer d-flex justify-content-between">
                            <span class="text-start">Source: <a href="https://my.clevelandclinic.org/health/diseases/4335-influenza-flu" target="_blank">Flu (Influenza)</a></span> 
            ...
            <div class="modal fade" id="homeRemedyModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Home Remedy For Flu</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <img src="../../images/homeremedy/flu.png" class="img-fluid">
                        </div>
                        <div class="modal-footer d-flex justify-content-between">
                            <span class="text-start">Source: <a href="https://www.healthline.com/health/natural-flu-remedies" target="_blank">10 Natural Remedies for Flu Symptoms</a></span> 
                            <button type="button" class="btn text-light" style="background-color: #76a6e5;" data-bs-dismiss="modal">Close</button>
                        </div>
                    </div>
                </div>
