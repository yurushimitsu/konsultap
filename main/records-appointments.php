...
if (isset($_SESSION['role'])) {
    ...
    $query = "SELECT description, date_added FROM procedure_history_records WHERE IdNumber = ? ORDER BY date_added DESC LIMIT ?, ?";
    $stmt = mysqli_prepare($conn, $query);
    ...
    // fetch total of rows
    $records = $conn->query("SELECT * FROM procedure_history_records WHERE IdNumber = $idNumber");
    ...
    $queryRecords = "SELECT *
    FROM procedure_history_records 
...
<body id="<?php echo $id ?>">
            ...
            <div class="col-auto col-md-3 col-xl-2 bg-transparent" style="padding: 0;">
                <div class="d-flex flex-column text-white" style="height: 85vh;">
                   <ul class="nav nav-pills flex-column mb-sm-auto mb-0 text-center" id="menu" style="background-color:#E4E4E4;">
                        <li class="nav-item">
                            <a href="records-appointments.php" class="nav-link py-5 fw-bold fs-4 text active">
            ...
            <div class="col position-relative">
                 <div class="col-lg-12 text-center pt-5 px-lg-5">
                    <div class="appointments-box">
                        <p class="fs-1 fw-bold m-0 p-1">APPOINTMENTS HISTORY</p>
                    </div>
                </div>
                            ...
                            <div class="col-lg-12 table-responsive">
                                ...
                                <table class="table table-bordered border-dark table-light lh-lg">
                                    <tbody class="col-sm-12">
                                        <!-- table header -->
                                        <tr>
                                            <td class="text-center fs-3 fw-bold px-lg-5" style="color: #000066;">Your Appointment Record</td>
                                        </tr>
                                        <?php
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                <td class="px-lg-5">
                                                    <!-- row head -->
                                                    <span class="fs-4 fw-bold" style="color: #000066;">Appointment Details</span>
                                                    <br>
                                                    <!-- row details -->
    ...
    No Available Appointment Record(s)
</div>
                <?php } ?>
            </div>
        </div>
