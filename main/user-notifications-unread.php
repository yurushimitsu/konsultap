...
if (isset($_SESSION['role'])) {
    ...
    // fetch total of rows
    $appointments = $conn->query("SELECT * FROM appointments a WHERE a.IdNumber = $idNumber AND a.is_unreadusers = 1");
...
<div class="container py-5">
    ...
    <div class="row px-lg-5 pb-3">
        <div>
            <a href="user-notifications.php" class="btn border border-dark position-relative" style="background-color:#E4E4E4 ; color: black;">ALL</a>
            <a href="user-notifications-unread.php" class="btn text-light border border-dark position-relative" style="background-color: #000066;">
                UNREAD
                <?php if (!empty($ctr)) {?>
